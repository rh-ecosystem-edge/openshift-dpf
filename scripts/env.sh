...
# DPF HCP Bridge Operator Configuration
DPF_HCP_BRIDGE_OPERATOR_CHART_URL=${DPF_HCP_BRIDGE_OPERATOR_CHART_URL:-"oci://quay.io/lhadad/charts/dpf-hcp-bridge-operator"}
DPF_HCP_BRIDGE_OPERATOR_NAMESPACE=${DPF_HCP_BRIDGE_OPERATOR_NAMESPACE:-"dpf-hcp-bridge-system"}
DPF_HCP_BRIDGE_OPERATOR_VERSION=${DPF_HCP_BRIDGE_OPERATOR_VERSION:-"0.1.0"}
DPF_HCP_BRIDGE_OPERATOR_IMAGE_REPO=${DPF_HCP_BRIDGE_OPERATOR_IMAGE_REPO:-"quay.io/lhadad/dpf-hcp-bridge-operator"}
DPF_HCP_BRIDGE_OPERATOR_IMAGE_TAG=${DPF_HCP_BRIDGE_OPERATOR_IMAGE_TAG:-"v0.1.0"}
DPFHCPBRIDGE_PULL_SECRET_NAME=${DPFHCPBRIDGE_PULL_SECRET_NAME:-"my-pull-secret"}
DPFHCPBRIDGE_SSH_SECRET_NAME=${DPFHCPBRIDGE_SSH_SECRET_NAME:-"my-ssh-key"}
